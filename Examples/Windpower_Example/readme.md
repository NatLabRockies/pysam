...
It then loads wind resource data from the `wind-resource-file.csv` file, which is a file from the NLR WIND Toolkit API: https://developer.nlr.gov/docs/wind/wind-toolkit/wtk-download/.
