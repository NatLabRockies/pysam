...
{
	return PySAM_double_getter(SAM_EtesPtes_TimeOfDeliveryFactors_start_day_of_year_nget, self->data_ptr);
}

static int
TimeOfDeliveryFactors_set_start_day_of_year(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_EtesPtes_TimeOfDeliveryFactors_start_day_of_year_nset, self->data_ptr);
}
