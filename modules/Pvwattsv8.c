...
static PyObject *
SpectralCorrection_new(SAM_Pvwattsv8 data_ptr)
{
...
SpectralCorrection_assign(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_assign_from_dict(self->data_ptr, dict, "Pvwattsv8", "SpectralCorrection")){
		return NULL;
	}
...
SpectralCorrection_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Pvwattsv8", "SpectralCorrection")){
		return NULL;
	}
...
{
	return PySAM_double_getter(SAM_Pvwattsv8_SpectralCorrection_celltech_nget, self->data_ptr);
}

static int
SpectralCorrection_set_celltech(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Pvwattsv8_SpectralCorrection_celltech_nset, self->data_ptr);
}

static PyObject *
SpectralCorrection_get_coeff_inputs_king(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Pvwattsv8_SpectralCorrection_coeff_inputs_king_aget, self->data_ptr);
}

static int
SpectralCorrection_set_coeff_inputs_king(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Pvwattsv8_SpectralCorrection_coeff_inputs_king_aset, self->data_ptr);
}

static PyObject *
SpectralCorrection_get_coeff_inputs_lee(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Pvwattsv8_SpectralCorrection_coeff_inputs_lee_aget, self->data_ptr);
}

static int
SpectralCorrection_set_coeff_inputs_lee(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Pvwattsv8_SpectralCorrection_coeff_inputs_lee_aset, self->data_ptr);
}

static PyObject *
SpectralCorrection_get_coeff_inputs_pelland(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Pvwattsv8_SpectralCorrection_coeff_inputs_pelland_aget, self->data_ptr);
}

static int
SpectralCorrection_set_coeff_inputs_pelland(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Pvwattsv8_SpectralCorrection_coeff_inputs_pelland_aset, self->data_ptr);
}

static PyObject *
SpectralCorrection_get_max_abs_airmass(VarGroupObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Pvwattsv8_SpectralCorrection_max_abs_airmass_nget, self->data_ptr);
}

static int
SpectralCorrection_set_max_abs_airmass(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Pvwattsv8_SpectralCorrection_max_abs_airmass_nset, self->data_ptr);
}

static PyObject *
SpectralCorrection_get_max_prec_water(VarGroupObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Pvwattsv8_SpectralCorrection_max_prec_water_nget, self->data_ptr);
}

static int
SpectralCorrection_set_max_prec_water(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Pvwattsv8_SpectralCorrection_max_prec_water_nset, self->data_ptr);
}

static PyObject *
SpectralCorrection_get_min_abs_airmass(VarGroupObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Pvwattsv8_SpectralCorrection_min_abs_airmass_nget, self->data_ptr);
}

static int
SpectralCorrection_set_min_abs_airmass(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Pvwattsv8_SpectralCorrection_min_abs_airmass_nset, self->data_ptr);
}

static PyObject *
SpectralCorrection_get_min_prec_water(VarGroupObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Pvwattsv8_SpectralCorrection_min_prec_water_nget, self->data_ptr);
}

static int
SpectralCorrection_set_min_prec_water(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Pvwattsv8_SpectralCorrection_min_prec_water_nset, self->data_ptr);
}

static PyObject *
SpectralCorrection_get_spectral_correction_model_choice(VarGroupObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Pvwattsv8_SpectralCorrection_spectral_correction_model_choice_nget, self->data_ptr);
}

static int
SpectralCorrection_set_spectral_correction_model_choice(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Pvwattsv8_SpectralCorrection_spectral_correction_model_choice_nset, self->data_ptr);
}
...
static PyTypeObject SpectralCorrection_Type = {
		 ...
		 * to be portable to Windows without using C++. */
		PyVarObject_HEAD_INIT(NULL, 0)
		"Pvwattsv8.SpectralCorrection",             /*tp_name*/
		sizeof(VarGroupObject),          /*tp_basicsize*/
		0,                          /*tp_itemsize*/
		/* methods */
		0,    /*tp_dealloc*/
...
Pvwattsv8Module_exec(PyObject *m)
{
	...
	/// Add the SpectralCorrection type object to Pvwattsv8_Type
