...
This page lists the input variables and default values that have changed between PySAM 5.0.0 and PySAM 4.2.0.
...
`Generic System <https://nlr-pysam.readthedocs.io/en/v5.0.0/modules/GenericSystem.html>`_ Modified Input Variables:
...
`Generic System <https://nlr-pysam.readthedocs.io/en/v5.0.0/modules/GenericSystem.html>`_ New Default files:

     - GenericPVWattsWindFuelCellBatteryHybridHostDeveloper
     - GenericPVWattsWindFuelCellBatteryHybridSingleOwner

`Generic System <https://nlr-pysam.readthedocs.io/en/v5.0.0/modules/GenericSystem.html>`_ Modified Default Values:
...
`Trough Physical Csp Solver <https://nlr-pysam.readthedocs.io/en/v5.0.0/modules/TroughPhysicalCspSolver.html>`_ Modified Input Variables:
...
`Trough Physical Csp Solver <https://nlr-pysam.readthedocs.io/en/v5.0.0/modules/TroughPhysicalCspSolver.html>`_ Removed Default files
