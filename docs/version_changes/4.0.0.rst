...
This page lists the input variables and default values that have changed between PySAM 4.0.0 and PySAM 3.0.2.
...
`Generic  System <https://nlr-pysam.readthedocs.io/en/v4.0.0/modules/GenericSystem.html>`_ Modified Input Variables:
...
`TroughPhysicalCspSolver <https://nlr-pysam.readthedocs.io/en/v4.0.0/modules/TroughPhysicalCspSolver.html>`_ Modified Input Variables:
...
`Trough Physical Process Heat <https://nlr-pysam.readthedocs.io/en/v4.0.0/modules/TroughPhysicalProcessHeat.html>`_  Modified Input Variables:
