...
This page lists the input variables and default values that have changed between PySAM 3.0.0 and PySAM 2.2.4.
...
`Trough Physical Process Heat <https://nlr-pysam.readthedocs.io/en/v3.0.0/modules/TroughPhysicalProcessHeat.html>`_ Modified Input Variables:
