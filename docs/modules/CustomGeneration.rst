...
CustomGeneration is a wrapper for the SSC compute module `cmod_custom_generation.cpp <https://github.com/NatLabRockies/ssc/blob/develop/ssc/cmod_custom_generation.cpp>`_
